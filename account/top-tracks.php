<html>
<head>
<title>Top Tracks of <?php echo date("Y")-1 ?> | Ghannely - Music For Everyone</title>
...
<div class="explore-new" style="display:block">
    <a href="#"><h5 style="color:white;margin-top:3%;margin-bottom:2%">Top tracks of <?php echo date("Y")-1 ?></h5></a>
    <a href="#">
